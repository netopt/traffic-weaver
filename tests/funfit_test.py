...
from traffic_weaver.funfit import lin_fit, exp_fit, exp_lin_fit, exp_xy_fit, lin_exp_xy_fit
...
@pytest.mark.parametrize('x, expected_y',
                         [(1, 1), (1.25, 1.875),  # (1 - (3/4) ** 2) * 2 = 0.875
...
@pytest.mark.parametrize('x, expected_y', [(1, 1), (1.25, 1.21875),
...
@pytest.mark.parametrize('x, expected_y', [(1, 1), (1.25, 1.59375),
